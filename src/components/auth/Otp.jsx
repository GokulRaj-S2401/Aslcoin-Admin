...
const Otp = ({ setOtp, otpval, email }) => {
  ...
  return (
    <div>
      ...
      <div onClick={() => { handleVerifyOtp(); setOtp(false); }} className="flex items-center justify-end px-5 font-light  bg-gradient-to-b from-[#9D6CFF]   to-[#1984FF]  mt-12  h-[60px] w-full md:w-[280px]  rounded-3xl ">
